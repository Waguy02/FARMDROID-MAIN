...
function estimateN_Need(rules, mesures) {
   ...
   var array=[rules.get(N_ESTIMATION),eau,rules.get(STANDARD),lux,temp_air,temp_sol,];
   // console.log(array)
    var parsed=session.consult(array.join('\n')); 
...
function estimateK_Need(rules, mesures) {
   ...
   var array=[rules.get(K_ESTIMATION),eau,rules.get(STANDARD),lux,temp_air,temp_sol,];
   // console.log(array)
    var parsed=session.consult(array.join('\n')); 
...
function estimateP_Need(rules, mesures) {
   ...
   var array=[rules.get(P_ESTIMATION),eau,rules.get(STANDARD),lux,eau,temp_air,temp_sol,];
   // console.log(array)
    var parsed=session.consult(array.join('\n')); 
